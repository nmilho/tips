            ...
            <div class="col-md-12">
                <div class="filters">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('admin.db.dbsportsupdate') }}">
                        ...
                        <div class="form-group{{ $errors->has('sportschk') ? ' has-error' : '' }}">  <!-- Checkbox Group !-->
                            <label class="control-label" style="display: block; text-align: left;">Choose sports to update</label>
                            @if ($errors->has('sportschk'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('sportschk') }}</strong>
                                </span>
                            @endif
                            @foreach($sports as $sport)
                                ...
                                <div class="col-md-2">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" id="sportschk[{{ $sport['id'] }}]" name="sportschk[{{ $sport['id'] }}]" value="{{$sport['name']}}">
